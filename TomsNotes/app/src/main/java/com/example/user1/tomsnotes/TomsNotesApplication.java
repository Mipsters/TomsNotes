...
public class TomsNotesApplication extends Application {
    ...
    public static final String APPLICATION_ID = "qZi5lpUgYesgdTvo9Weh5iwOcd9TxZDw1qUxwo08";

    public static final String SERVER_ADDRESS = "https://parseapi.back4app.com/";

    public static final String CLIENT_KEY = "QCUUC3lJrahGlrTqqiSkHextbFrdnSbDQW37rnA3";
